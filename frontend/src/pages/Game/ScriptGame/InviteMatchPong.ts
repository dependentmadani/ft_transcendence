...
// function verfyToken(Token:string)
// {
...
// export function ping_pong(canvas :any,Token:any,leftCallback:any , rightCallback:any)
// {
//     if(canvas)
//     {
//         let ctx:any = canvas.getContext('2d');
...
//         img_lose.src = "/src/FrontGame/lose.jpg";
//         img_win.src = "/src/FrontGame/win.jpg";
        
//         ball_sound.src = "/src/sounds/beeep.ogg";
//         paddle_sound.src = "/src/sounds/Pop.ogg" ;
//         music.src = "/src/sounds/hxh.mp3";
//         img.src = "/src/FrontGame/tenis.jpg"
        
//         const socket = io('http://10.14.10.5:9000');
