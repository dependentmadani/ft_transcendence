...
export class NotificationController {
  ...
  async friendAcception(
    ...
    // console.log('------------------------------')
    return await this.notificationService.acceptFriend(
      senderId,
      receiverId,
      notifId,
    );
  ...
  async deleteNotification(
    ...
    receiverId: number,
    @Param('notifId', ParseIntPipe)
    notifId: number,
  ) {
    return this.notificationService.refureFriend(
      senderId,
      receiverId,
      notifId,
    );
