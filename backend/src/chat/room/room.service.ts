...
export class RoomService {
  ...
  async getOneRoom(
    ...
    try {
      ...
      console.log(
        `Couldn't find any room with id: ${roomId} ${err}`,
      );
    }
  }
  ...
  async getRoomAvatar(
    ...
    try {
      ...
      console.log(
        `Couldn't find any room with id: ${id} ${err}`,
      );
    }
  }
  ...
  async updateRoom(
    ...
    try {
      ...
      console.log(
        `Couldn't create room with id ${roomId}`,
      );
    }
  }
  ...
  async deleteAllRooms() {
    ...
    else return `Couldn't delete rooms!`;
  }
